...
assert_contains "$RUN_RECORD" "argc=8" "default mode preserves passthrough count after charter and plugin args"
...
assert_contains "$RUN_RECORD" "argv[4]=--model" "passthrough arg 1 reaches claude"
assert_contains "$RUN_RECORD" "argv[5]=opus" "passthrough arg 2 reaches claude"
assert_contains "$RUN_RECORD" "argv[6]=prompt with spaces" "passthrough with spaces reaches claude"
assert_contains "$RUN_RECORD" "argv[7]=--flag=value" "passthrough flag reaches claude"
...
assert_contains "$RUN_RECORD" "argc=7" "default model injection preserves passthrough count after charter, plugin, and model args"
...
assert_contains "$RUN_RECORD" "argv[4]=--model" "default mode injects model flag"
assert_contains "$RUN_RECORD" "argv[5]=glm-5.2[1m]" "default mode injects GLM model"
assert_contains "$RUN_RECORD" "argv[6]=prompt with default model" "default model preserves passthrough"
...
assert_contains "$RUN_RECORD" "argc=5" "ALBION_MODEL run has plugin args, model args, and passthrough"
...
assert_contains "$RUN_RECORD" "argv[2]=--model" "ALBION_MODEL injects model flag"
assert_contains "$RUN_RECORD" "argv[3]=bar" "ALBION_MODEL value reaches claude"
assert_contains "$RUN_RECORD" "argv[4]=prompt with env model" "ALBION_MODEL preserves passthrough"
...
assert_contains "$RUN_RECORD" "argv[2]=--model" "missing charter injects model flag"
assert_contains "$RUN_RECORD" "argv[3]=glm-5.2[1m]" "missing charter injects default model"
assert_contains "$RUN_RECORD" "argv[4]=still runs" "missing charter preserves passthrough"
