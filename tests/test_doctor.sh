...
assert_contains "$RUN_STDOUT" "7 pass, 1 fail, 1 warn, 0 skip" "version failure summary counts"
...
assert_contains "$RUN_STDOUT" "7 pass, 0 fail, 2 warn, 0 skip" "version warning summary counts"
...
assert_contains "$RUN_STDOUT" "8 pass, 0 fail, 1 warn, 0 skip" "version pass summary counts"
...
assert_contains "$RUN_STDOUT" "9 pass, 0 fail, 0 warn, 0 skip" "tmux presence summary counts"
...
assert_contains "$RUN_STDOUT" "7 pass, 1 fail, 1 warn, 0 skip" "endpoint failure summary counts"
...
assert_contains "$RUN_STDOUT" "9 pass, 0 fail, 1 warn, 0 skip" "live success summary counts"
...
assert_contains "$RUN_STDOUT" "7 pass, 2 fail, 1 warn, 0 skip" "wrong model summary counts"
...
assert_contains "$RUN_STDOUT" "5 pass, 1 fail, 1 warn, 3 skip" "missing token summary counts"
